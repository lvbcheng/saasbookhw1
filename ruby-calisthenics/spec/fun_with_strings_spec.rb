...
describe 'palindrome detection' do
  it 'should work for simple strings [10 points]' do
    'A'.should be_a_palindrome
    'a'.should be_a_palindrome
    'aba'.should be_a_palindrome
    'abba'.should be_a_palindrome
    'aba'.should be_a_palindrome
    'a!ba'.should be_a_palindrome

    'redivider'.should  be_a_palindrome
    'abracadabra'.should_not  be_a_palindrome
  end
  it 'should be case-insensitive [10 points]' do
    'Aaa'.should be_a_palindrome
    'aAa'.should be_a_palindrome
    'aAA'.should be_a_palindrome
    'aBa'.should be_a_palindrome
    'aBba'.should be_a_palindrome
    'abBa'.should be_a_palindrome
    'abBBa'.should be_a_palindrome
    'aaAaBBBBBBaaaa'.should be_a_palindrome
    'abA'.should be_a_palindrome
    'ReDivider'.should be_a_palindrome
  end
